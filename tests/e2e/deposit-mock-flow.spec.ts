...
const mockAuthSession = {
  ...
  sessionExpiresAt: '2025-12-12T11:00:00.000Z',
  userData: {
    id: 64096067,
...
async function installApiMocks(page: Page) {
  await page.route('**/api/v1/auth/telegram/session', (route) => route.fulfill({ status: 200, contentType: 'application/json', body: JSON.stringify(mockAuthSession) }));
